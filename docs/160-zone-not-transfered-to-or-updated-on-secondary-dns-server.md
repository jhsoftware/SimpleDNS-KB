...
Make sure that any firewall between the primary and the secondary servers allows TCP connections to port 53.  
...
If the problem description is "RCODE 5 Refused...", check the reference knowledge base article about this below.
