...
Computers and devices behind a NAT router all have private IP addresses (typically 192.168.x.x), which are translated into a shared public IP address by the router.
...
Simple DNS Plus (and other DNS servers) uses port number 53 UDP and TCP.
