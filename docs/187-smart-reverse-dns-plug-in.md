...
The plug-in will respond with reverse DNS records pointing to a synthesized host name in the format &lt;prefix&gt;&lt;ip-address-&gt;&lt;suffix&gt;. Dots and colons in IP addresses are replaced with hyphens, and you can choose to either include the full IP address or just the right part (as per subnet size).
...
\- **IP address**  
How much of the IP address should be included in the synthesized host name. Choose "Full" or "Right part".  
\- **Suffix**  
