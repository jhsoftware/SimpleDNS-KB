...
To solve this, you can either try connecting with a lower color depth (256 colors), or set the group policy on the server computer to allow a higher color depth, and then connect requesting 16-bit color depth.  
