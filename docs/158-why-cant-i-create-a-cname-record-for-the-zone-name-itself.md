...
Instead of the CNAME-record, you can set up an A-record pointing directly to the IP address of whatever server the aliased name is pointing to.
...
> The results of this are unpredictable and often cause serious problems because in some situations the CNAME-record will override other critical records at the zone root level - for example, hiding the NS- and SOA-records.