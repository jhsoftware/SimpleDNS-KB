...
NOTE: Only IIS versions for Windows Server and Windows Vista support multiple websites as described below. If you are using Windows 98, Me, NT4 Workstation, Windows 2000 Professional, or Windows XP, please see the reference article below instead.
...
From the "Internet Information Services (IIS) Manager" window, right-click on a website and select "Properties":

![](img/143/1.png)

In the website Properties dialog, click the "Advanced..." button:
...
Enter the website domain name in the "Host Header Name" field:

![](img/143/4.png)

Click the OK button in all the dialogs to save your changes.

Create additional websites the same way.
